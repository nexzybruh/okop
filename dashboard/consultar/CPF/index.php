...
if(isset($_GET['consultar'])){
    $cpf = str_replace(' ', '', filter_input(INPUT_GET, 'cpf', FILTER_SANITIZE_STRING));



    $curl = curl_init();
    curl_setopt_array($curl, [
        CURLOPT_URL => "http://20.201.114.230/api/cpf.php?cpf=" . $cpf,
        ...
        CURLOPT_HTTPHEADER => [
            ...
            'cookie: PHPSESSID=p4e78kttg87kqptdoaksveh5n2',
...
<div class="tablOverflow">
    <table style="font-size: calc(1.0vh + 0.7rem);color:white" width="100%" class="table_listagem">
        <tbody>
            ...
            <?php if (!empty($json["records"])): ?>
                <?php $record = $json["records"][0]; // Pega o primeiro registro ?>
                <tr bgcolor="#202020"><td colspan="2"><b>Nome:</b></td><td colspan="2"><b>Nome da Mãe:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["nome"]; ?></td>
                    <td colspan="2"><?php echo $record["nomeMae"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Sexo:</b></td><td colspan="2"><b>Data de Nascimento:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["sexo"]; ?></td>
                    <td colspan="2"><?php echo $record["dataNascimento"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Idade:</b></td><td colspan="2"><b>CPF:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo date_diff(date_create($record["dataNascimento"]), date_create('now'))->y; ?></td>
                    <td colspan="2"><?php echo $record["cpf"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Nacionalidade:</b></td><td colspan="2"><b>Raça/COR:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["nacionalidade"]["paisNascimento"] ?? 'N/A'; ?>, <?php echo $record["nacionalidade"]["municipioNascimento"] ?? 'N/A'; ?></td>
                    <td colspan="2"><?php echo $record["racaCor"] ?? 'N/A'; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Obito:</b></td><td colspan="2"><b>Data de Obito:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["obito"] ? "Sim" : "Não"; ?></td>
                    <td colspan="2"><?php echo $record["dataObito"] ?? "N/A"; ?></td>
                </tr>

                <tr><td class="td_titulo_tabela" colspan="4">Endereço:</td></tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Logradouro:</b></td><td colspan="2"><b>Estado:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo (isset($record["endereco"]["logradouro"]) ? $record["endereco"]["logradouro"] : 'N/A') . ', ' . (isset($record["endereco"]["numero"]) ? $record["endereco"]["numero"] : 'N/A'); ?></td>
                    <td colspan="2"><?php echo $record["endereco"]["estado"] ?? 'N/A'; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Cidade:</b></td><td colspan="2"><b>Bairro:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["endereco"]["municipio"] ?? 'N/A'; ?></td>
                    <td colspan="2"><?php echo $record["endereco"]["bairro"] ?? 'N/A'; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>CEP:</b></td><td colspan="2"><b>Telefone:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["endereco"]["cep"] ?? 'N/A'; ?></td>
                    <td colspan="2"><?php echo !empty($record["telefone"]) ? implode(", ", array_map(fn($t) => $t['numero'], $record["telefone"])) : 'N/A'; ?></td>
                </tr>
            <?php else: ?>
                <tr>
    ...
    <table style="font-size: calc(1.0vh + 0.7rem);color:white" width="100%" class="table_listagem">
        <tbody>
            <tr><td class="td_titulo_tabela" colspan="4">Vacinas:</td></tr>
            <?php if (!empty($record["vacinas"])): ?>
                <?php foreach ($record["vacinas"] as $vacina): ?>
                    <tr bgcolor="#202020">
                        <td><b>Tipo:</b> <?php echo $vacina["Tipo"]; ?></td>
                        <td><b>Vacina:</b> <?php echo $vacina["Vacina"]; ?></td>
                        <td><b>Data Aplicação:</b> <?php echo $vacina["dataAplicacao"]; ?></td>
                        <td><b>Vacinador:</b> <?php echo $vacina["Vacinador"]; ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="4" style="text-align: center; color: red;">Nenhuma vacina registrada.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
