...
<span>Consulta de Placa nacional:</span>
<div class="centralContainer">
<form method="GET">
<input name="placa" id="placa" class="valueConsulta" type="text" placeholder="PLACA EX. ABC1234">
<span style="width: 70%;">
<div>
...
if (isset($_GET['consultar'])) {
    $placa = $_GET["placa"]; // Ensure the variable is named correctly

    $curl = curl_init();
    curl_setopt_array($curl, [
        CURLOPT_URL => "http://62.72.8.251:5000/vehicle/" . $placa,
...
<div class="tablOverflow">
    ...
    <table style="font-size: calc(1.0vh + 0.7rem); color:white;" width="100%" class="table_listagem">
        <tbody>
            <tr><td class="td_titulo_tabela" colspan="4">Dados do Veículo:</td></tr>

            <?php if (!empty($json)): ?>
                <?php $record = $json; ?>
                <?php 
                    // Concatenate owner information into a single string
                    $ownerInfo = sprintf(
                        "%s, %s, %s - %s",
                        $record["proprietario"]["nome"],
                        $record["proprietario"]["tipoDocumento"],
                        $record["proprietario"]["numeroDocumento"],
                        $record["proprietario"]["endereco"]
                    );
                ?>
                <tr bgcolor="#202020"><td colspan="2"><b>Informações do Proprietário:</b></td><td colspan="2"><?php echo $ownerInfo; ?></td></tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Placa:</b></td><td colspan="2"><b>UF:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["placa"]; ?></td>
                    <td colspan="2"><?php echo $record["ufEmplacamento"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Marca/Modelo:</b></td><td colspan="2"><b>Ano de Fabricação:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["marcaModelo"]; ?></td>
                    <td colspan="2"><?php echo $record["anoFabricacao"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Ano do Modelo:</b></td><td colspan="2"><b>Ano do Último Licenciamento:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["anoModelo"]; ?></td>
                    <td colspan="2"><?php echo $record["anoUltimoLicenciamnento"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Chassi:</b></td><td colspan="2"><b>Renavam:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["chassi"]; ?></td>
                    <td colspan="2"><?php echo $record["renavam"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Cor:</b></td><td colspan="2"><b>Combustível:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["cor"]; ?></td>
                    <td colspan="2"><?php echo $record["combustivel"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Cilindrada:</b></td><td colspan="2"><b>Peso Bruto Total:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["cilindrada"]; ?></td>
                    <td colspan="2"><?php echo $record["pesoBrutoTotal"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Potência:</b></td><td colspan="2"><b>Capacidade Máxima Carga:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["potencia"]; ?></td>
                    <td colspan="2"><?php echo $record["capacidadeMaximaCarga"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Capacidade Máxima Tração:</b></td><td colspan="2"><b>Tipo de Veículo:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["capacidadeMaximaTracao"]; ?></td>
                    <td colspan="2"><?php echo $record["tipoVeiculo"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Grupo do Veículo:</b></td><td colspan="2"><b>Categoria:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["grupoVeiculo"]; ?></td>
                    <td colspan="2"><?php echo $record["categoria"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Especie:</b></td><td colspan="2"><b>Lotação:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["especie"]; ?></td>
                    <td colspan="2"><?php echo $record["lotacao"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Arrendatário:</b></td><td colspan="2"><b>Endereço do Arrendatário:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["arrendatario"]["placa"]; ?></td>
                    <td colspan="2"><?php echo $record["arrendatario"]["endereco"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Tipo de Montagem:</b></td><td colspan="2"><b>Município da Placa:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["tipoMontagem"]; ?></td>
                    <td colspan="2"><?php echo $record["municipioPlaca"]; ?></td>
                </tr>
                <tr bgcolor="#202020"><td colspan="2"><b>Número do Motor:</b></td><td colspan="2"><b>Valor do IPVA:</b></td></tr>
                <tr>
                    <td colspan="2"><?php echo $record["numeroMotor"]; ?></td>
                    <td colspan="2"><?php echo $record["valorIPVA"]; ?></td>
                </tr>
            <?php else: ?>
                <tr>
