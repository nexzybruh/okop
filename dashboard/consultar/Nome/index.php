...
<span>Consulta de Nome:</span>
<div class="centralContainer">
    <form method="GET">
        <input name="nome" id="nome" class="valueConsulta" type="text" placeholder="NOME EX. JAIR MESSIAS BOLSONARO">
        <span style="width: 70%;">
            <div>
...
<?php
$mysqli = new mysqli("127.0.0.1", "root", "", "xfind");
...
if (isset($_GET['consultar'])) {
    ...
    $query = "SELECT * FROM pessoas WHERE Nome_Completo LIKE ? LIMIT 500";
...
<div class="tablOverflow">
    <table style="font-size: calc(1.0vh + 0.7rem); color: white;" width="100%" class="table_listagem">
        <tbody>
            <tr>
                <td class="td_titulo_tabela" colspan="4">Dados Pessoais:</td>
            </tr>

            <?php if (!empty($pessoas)): ?>
                <?php foreach ($pessoas as $record): ?>
                    <tr bgcolor="#202020">
                        <td colspan="2"><b>Nome:</b></td>
                        <td colspan="2"><b>CPF:</b></td>
                    </tr>
                    <tr>
                        <td colspan="2"><?php echo htmlspecialchars($record["Nome_Completo"]); ?></td>
                        <td colspan="2">
                            <a href="/dashboard/consultar/CPF/?cpf=<?php echo urlencode($record['CPF']); ?>&consultar=" style="color: #D5006D; text-decoration: underline;">
                                <?php echo htmlspecialchars($record["CPF"]); ?>
                            </a>
                        </td>
                    </tr>
                    <tr bgcolor="#202020">
                    ...
                    <tr>
                        <td colspan="2"><?php echo htmlspecialchars($record["Sexo_Genero"]); ?></td>
                        <td colspan="2"><?php echo htmlspecialchars($record["Data_Nascimento"]); ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
