...
<span>Consulta de RADAR(PLACA):</span>
...
if (isset($_GET['consultar'])) {
    ...
    curl_setopt_array($curl, [
        CURLOPT_URL => "http://127.0.0.1:9000/search_vehicle/" . $placa,
...
<?php if (isset($_GET['consultar']) && !empty($json)): ?>
...
<div class="tablOverflow">
    ...
    <table style="font-size: calc(1.0vh + 0.7rem); color:white;" width="100%" class="table_listagem">
        <tbody>
            ...
            <?php foreach ($json['track_response'] as $record): ?>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Placa:</b></td>
                    <td colspan="2"><?php echo $record['vehicle']['plate']; ?></td>
                </tr>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Modelo:</b></td>
                    <td colspan="2"><?php echo $record['vehicle']['model']['description']; ?></td>
                </tr>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Cor:</b></td>
                    <td colspan="2"><?php echo $record['vehicle']['color']['description']; ?></td>
                </tr>

                <tr bgcolor="#202020">
                    <td colspan="2"><b>Imagem:</b></td>
                    <td colspan="2">
                        <img src="data:image/jpeg;base64,<?php echo $json['image_response']; ?>" style="max-width: 200px; max-height: 200px;">
                    </td>
                </tr>
                
                <tr><td colspan="4" style="height: 20px;"></td></tr>
                
                <tr><td class="td_titulo_tabela" colspan="4">Informações da Câmera:</td></tr>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Câmera:</b></td>
                    <td colspan="2"><?php echo $record['camera']['alias']; ?></td>
                </tr>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Endereço:</b></td>
                    <td colspan="2"><?php echo $record['camera']['address']['alias']; ?></td>
                </tr>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Cidade:</b></td>
                    <td colspan="2"><?php echo $record['camera']['address']['city']['name']; ?></td>
                </tr>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Estado:</b></td>
                    <td colspan="2"><?php echo $record['camera']['address']['uf']['description']; ?></td>
                </tr>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Bairro:</b></td>
                    <td colspan="2"><?php echo $record['camera']['address']['neighbourhood']; ?></td>
                </tr>
                <tr bgcolor="#202020">
                    <td colspan="2"><b>Rua:</b></td>
                    <td colspan="2"><?php echo $record['camera']['address']['street']; ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
...
<?php else: ?>
    <div style="text-align: center; color: red;">Nenhum dado encontrado.</div>
<?php endif; ?>
